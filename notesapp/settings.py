...
ALLOWED_HOSTS = ['*']  # Allow all hosts, should be restricted in production!
...
# Database
# Check for MySQL credentials; use SQLite as fallback.
...
print(f"DEBUG: Using DATABASES configuration = {DATABASES}")
